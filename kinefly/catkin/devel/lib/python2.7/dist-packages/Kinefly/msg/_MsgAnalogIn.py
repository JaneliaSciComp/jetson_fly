...
"""autogenerated by genpy from Kinefly/MsgAnalogIn.msg. Do not edit."""
import sys
...
class MsgAnalogIn(genpy.Message):
  _md5sum = "d1104d288960ba3fc4b4f45dd14127fa"
  _type = "Kinefly/MsgAnalogIn"
...
string frame_id
"""
  __slots__ = ['header','channels','voltages']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MsgAnalogIn, self).__init__(*args, **kwds)
